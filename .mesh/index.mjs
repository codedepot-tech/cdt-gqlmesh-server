...
import ExternalModule_3 from './sources/BybitExchange/oas-schema.js';
const importedModules = {
    ...
    // @ts-ignore
    [".mesh/sources/BybitExchange/oas-schema.js"]: ExternalModule_3
};
...
export const rawConfig = { "sources": [{ "name": "BybitExchange", "handler": { "openapi": { "source": "https://raw.githubusercontent.com/bybit-exchange/api-connectors/master/swagger.json" } } }] };
export async function getMeshOptions() {
    ...
    const bybitExchangeHandler = new OpenapiHandler({
