...
const oas_schema_js_1 = (0, tslib_1.__importDefault)(require("./sources/BybitExchange/oas-schema.js"));
const importedModules = {
    ...
    // @ts-ignore
    [".mesh/sources/BybitExchange/oas-schema.js"]: oas_schema_js_1.default
};
...
exports.rawConfig = { "sources": [{ "name": "BybitExchange", "handler": { "openapi": { "source": "https://raw.githubusercontent.com/bybit-exchange/api-connectors/master/swagger.json" } } }] };
async function getMeshOptions() {
    ...
    const sources = [];
    const transforms = [];
    const bybitExchangeTransforms = [];
    const additionalTypeDefs = [];
    const bybitExchangeHandler = new openapi_2.default({
    ...
    sources.push({
        name: 'BybitExchange',
        handler: bybitExchangeHandler,
        transforms: bybitExchangeTransforms
    });
